...
const TYPE_BADGE: Record<ScreenType, { label: string; bg: string; color: string }> = {
  screen:  { label: "Screen",  bg: "rgba(139,146,255,0.12)", color: "var(--md-sys-color-neonindigo)" },
  sheet:   { label: "Sheet",   bg: "rgba(46,204,113,0.12)",  color: "#2ECC71" },
  drawer:  { label: "Drawer",  bg: "rgba(245,166,35,0.12)",  color: "#F5A623" },
  modal:   { label: "Modal",   bg: "rgba(255,107,90,0.12)",  color: "var(--md-sys-color-brand-coral)" },
};
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, marginBottom: 12 }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
            <h3 style={{ fontSize: 16, fontWeight: 700, color: "var(--md-sys-color-text-primary)", margin: 0 }}>
              {screen.name}
            </h3>
...
const COLOR_GROUPS: { label: string; tokens: { name: string; value: string; usage: string }[] }[] = [
  ...
  },
  {
    ...
    tokens: [
      { name: "--md-sys-color-brand-coral-light", value: "#FF8F82", usage: "Task count badges" },
      { name: "--md-sys-color-brand-coral",       value: "#FF6B5A", usage: "Log a Visit CTA, overdue due dates, destructive actions" },
    ],
  },
  {
  ...
  },
  {
    label: "Semantic",
    tokens: [
      { name: "--md-sys-color-success", value: "#2ECC71", usage: "Completion checkmark fill, 'Done' badge, 'Saved' indicator" },
      { name: "--md-sys-color-warning", value: "#F5A623", usage: "Due-soon warnings" },
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <Section id="overview" title="Overview">
            ...
            <div style={{
              ...
              <p style={{ fontSize: 12, color: "var(--md-sys-color-text-secondary)", lineHeight: 1.65, margin: 0 }}>
                <strong style={{ color: "var(--md-sys-color-text-primary)" }}>Completion routing pattern: </strong>

              ...
              >
                ...
                <div className="flex items-center justify-between px-4 pt-12 pb-4 flex-shrink-0">
                  <div className="flex items-center gap-2">
                    <Icon name="auto_awesome" size={16} style={{ color: "var(--md-sys-color-neonindigo)" }} />
                    <span style={{ fontSize: 16, fontWeight: 700, color: "var(--md-sys-color-text-primary)" }}>Halosight AI</span>
                  </div>
                  <button
                    onClick={() => setExpanded(false)}
                    className="flex items-center justify-center active:opacity-60 transition-opacity"
                    style={{ width: 32, height: 32, borderRadius: "50%", background: "var(--md-sys-color-dark-secondary)" }}
                  >
                ...
                <div className="flex flex-col flex-1 overflow-hidden px-4 pb-8">
                  {!isConversing && (
                    <p style={{ fontFamily: "Roboto Slab, Georgia, serif", fontSize: 22, fontWeight: 700, color: "var(--md-sys-color-text-primary)", lineHeight: 1.25, marginBottom: 20 }}>
                      {greeting()}, Jordan.
                    </p>
                  )}
                  <AIChatBody
  ...
  return (
    <div className="px-4 pb-5">
      ...
      >
        ...
        >
          <Icon name="mic" size={16} style={{ color: "var(--md-sys-color-text-primary)" }} />

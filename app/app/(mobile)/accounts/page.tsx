 ...
 *         --md-sys-color-text-muted, --md-sys-color-text-disabled, --md-sys-color-alpha-white-10
 *
    ...
    <div className="relative flex flex-col h-full" style={{ background: "var(--md-sys-color-background)" }}>
      ...
      <div className="flex items-center gap-2 px-4 pb-3">
        <div
          ...
          style={{ background: "var(--md-sys-color-dark-secondary)" }}
        >
          <Icon name="search" size={18} style={{ color: "var(--md-sys-color-text-muted)", flexShrink: 0 }} />
          <input
            type="text"
            placeholder="Search"
            value={query}
          ...
          {query && (
            <button onClick={() => setQuery("")} className="active:opacity-60 flex-shrink-0">
              <Icon name="cancel" fill size={16} style={{ color: "var(--md-sys-color-text-disabled)" }} />
            </button>
          )}
        </div>
